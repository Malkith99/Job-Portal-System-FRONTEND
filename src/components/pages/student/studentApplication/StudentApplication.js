  ...
  function handleChange(e) {
    ...
    return (
        <div className='container'>
              <h1 className="cmp-headings loginN" style={{marginBottom:'2rem'}}>Student Application :</h1>
              <form>
                <div className='flex-container1'>
                  <div className="container1-flex-item">
                    ...
                    >
                      ...
                      <span className="asterisk-mark"><div className={`${props.disabled && "d-none"}`}>*</div></span> Profile Photo</label>
                ...
                <div className='flex-container1'>
                  ...
                  >
                    <label for="jobPosition" className="">
                      <span className="asterisk-mark"><div className={`${props.disabled && "d-none"}`}>*</div></span>Full Name
                    </label>
                  ...
                  >
                    <label for="jobPosition" className="">
                      <span className="asterisk-mark"><div className={`${props.disabled && "d-none"}`}>*</div></span>Name with Initials
                    </label>
                    <div className="input-filed input-filed-cls">
                      <input
                        type="text"
                ...
                <div 
                  ...
                  >
                    <label for="jobPosition" className="">
                      <span className="asterisk-mark"><div className={`${props.disabled && "d-none"}`}>*</div></span>Date of Birth
                    </label>
                    <div className="input-filed input-filed-cls">
                      <input
                        type="date"
                  ...
                  >
                    <label for="jobPosition" className="">
                      <span className="asterisk-mark"><div className={`${props.disabled && "d-none"}`}>*</div></span>Age
                    </label>
                    <div className="input-filed input-filed-cls">
                      <input
                        type="text"
                  ...
                  <div className='flex-container1'>
                      ...
                      >
                        <label for="jobPosition" className="">
                          <span className="asterisk-mark"><div className={`${props.disabled && "d-none"}`}>*</div></span>CV
                        </label>
                        <div className="input-filed input-filed-cls">
                          <input
                            type="file"
                    ...
                    <div className='flex-container1'>
                      ...
                      >
                        <label for="jobPosition" className="">
                          <span className="asterisk-mark"><div className={`${props.disabled && "d-none"}`}>*</div></span>Linkedin Profile
                        </label>
                        <div className="input-filed input-filed-cls">
                          <input
                            type="text"
                    ...
                    <div className="flex-container1">
                        <div className="container1-flex-item" style={{paddingBottom:"30px"}}>
                          <label className="">
                            <span className="asterisk-mark"><div className={`${props.disabled && "d-none"}`}>*</div></span>Reference
                          </label>
