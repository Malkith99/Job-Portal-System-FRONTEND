      ...
      <div>
        ...
        <Routes>
          ...
          <Route
            ...
            element={<StudentRegistrationBasicPage />}
          >
            {" "}
          </Route>
          <Route
            path="/student-register-step-2"
            element={<StudentRegistrationStep_2 />}
          >
            {" "}
          </Route>
          ...
          <Route path="/student-applications" element={<StudentAppliation />}>
            {" "}
          </Route>
          ...
          <Route path="/company-job-pool" element={<CompanyJobPool />}>
            {" "}
          </Route>
          <Route path="/all-student-responces" element={<AllResponses />}>
            {" "}
          </Route>
          ...
          {/*normaly the home page featers at the end*/}
        </Routes>
      </div>
    </BrowserRouter>
    /*<div className="App">
